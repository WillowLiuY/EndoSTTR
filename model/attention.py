...
class MultiheadAttentionRelative(nn.MultiheadAttention):
    ...
    def __init__(self, embed_dim, num_heads):
        """
        :param embed_dim: dim of the input embeddings.
        :param num_heads: number of attention heads.
        """
        super(MultiheadAttentionRelative, self).__init__(embed_dim, num_heads, dropout=0.0, bias=True, add_bias_kv=False, add_zero_attn=False,kdim=None, vdim=None)

    def forward(self, query, key, value, attn_mask=None, pos_enc=None, pos_indexes=None):
        """
        Multihead attention

        :param query: [W,HN,C], where W is the sequence length, HN is the batch size times the number of heads, and C is the embedding dimension.
        :param key: [W,HN,C]
        :param value: [W,HN,C]
